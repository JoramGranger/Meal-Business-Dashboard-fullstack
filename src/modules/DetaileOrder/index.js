      ...
      <List dataSource={dishes} 
        renderItem={(dishItem) => (
          <List.Item>
            ...
            <div>UGX {dishItem.Dish.price}</div>
          </List.Item>
        )}
      />
      <Divider />
      ...
      <Divider />
      {
        order?.status === OrderStatus.NEW && (
          <div style={styles.buttonsContainer}>
            ...
            <Button block type='danger' size='large' style={styles.button} onClick={declineOrder}>Decline Order</Button>
            <Button block type='primary' size='large' style={styles.button} onClick={acceptOrder}>Accept Order</Button>
          </div>          
        )
      }
      {
        order?.status === OrderStatus.COOKING && (
          <Button block type='primary' size='large' onClick={readyForPickup}>Food is Ready</Button>
        )
      }
    </Card>
  );
